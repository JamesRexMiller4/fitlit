...
describe('Activity', function() {
  ...
  beforeEach(() => {
    userRepository = new UserRepository(data2);
  ...
  it('should have a method that returns a users minutes active for a given week', function() {
    expect(activity.minActiveWeek("2019/09/15")).to.eql([174, 166, 144, 92, 270, 165, 212])
  });
  ...
  it('should have a method that returns the users flights of stairs for a week', function() {
    expect(activity.stairsWeek('2019/09/15')).to.eql([19, 46, 30, 40, 44, 15,  9])
  });
});